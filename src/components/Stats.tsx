...
const Stats = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-biosoft-gray-dark via-biosoft-blue to-biosoft-blue-light relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-gradient-to-r from-biosoft-green to-biosoft-orange-light rounded-full blur-2xl animate-float animate-delay-200"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-3 mb-8 animate-fade-in-up">
            ...
            <span className="text-biosoft-gray font-semibold text-sm tracking-wide uppercase">Proven Results</span>
          </div>

          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 animate-fade-in-up animate-delay-100">
            Trusted Across the
            <span className="block bg-gradient-to-r from-biosoft-blue-light to-biosoft-blue-lighter bg-clip-text text-transparent">Healthcare Industry</span>
          </h2>

          <p className="text-xl text-biosoft-gray max-w-3xl mx-auto leading-relaxed font-light animate-fade-in-up animate-delay-200">
            Our platform delivers measurable improvements in healthcare delivery and operational efficiency for providers worldwide.
          </p>
        </div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 hover:bg-white/15 transition-all duration-700 hover-lift group-hover:scale-105 border border-white/10 hover:border-white/20">
                <div
                  className={`w-20 h-20 mx-auto mb-8 rounded-2xl bg-gradient-to-r ${stat.color} flex items-center justify-center group-hover:scale-110 transition-all duration-500 shadow-2xl`}
                >
                  <stat.icon className="h-10 w-10 text-white transform group-hover:rotate-12 transition-transform duration-300" />
                </div>

                <div className="text-5xl md:text-6xl font-black text-white mb-4 group-hover:scale-110 transition-transform duration-300 bg-gradient-to-r from-white to-biosoft-gray bg-clip-text">
                  {stat.number}
                </div>

                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-biosoft-blue-light transition-colors duration-300">{stat.label}</h3>

                <p className="text-biosoft-gray group-hover:text-white transition-colors duration-300 font-medium">{stat.description}</p>
              </div>
            </div>
          ))}
        </div>
